          ...
          <tbody>
            {transactions.data?.map((t) => (
              <tr key={t.id} className="border-b border-line last:border-0">
                <td className="px-5 py-3 text-muted">{t.transactionDate}</td>
                <td className="px-5 py-3 text-muted">{t.type}</td>
                <td className="px-5 py-3 text-ink">{t.description ?? '—'}</td>
                <td className="px-5 py-3 text-ink">{money(t.amountCents)}</td>
              </tr>
            ))}
          </tbody>
        </table>
